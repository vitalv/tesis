...
%COMET ?!
\textit{ Ya que se usa en PeptideAtlas2... nombrarlo al menos??}
...
PSMs que han sido ordenados por \textit{p-valores} o \textit{e-valores} obtenidos individualmente.
...
Con esta hipótesis nula, la estrategia asume una idea básica central:
...
tienen el mismo tamaño, el número de PSMs incorrectos o Falsos Positivos
...
puntuaciones más altas a PSMs \textit{señuelo} que a PSMs \textit{target}
incorrectos \citep{Navarro2009a} por lo que la distribución de puntuaciones
\textit{señuelo} no es un reflejo preciso de la distribución de puntuaciones
de los PSMs incorrectos.
...
considerando que la mayoría de los PSMs con puntuaciones bajas son 
...
%usando búsquedas separadas consiste en e %refined FDR (J. Vazquez)
