...
Parte de los resultados del PeptideAtlas de \textit{C. albicans} descritos
...
\textit{C. albicans} es un hongo unicelular diploide de la clase \textit{Saccharomycetes}, patógeno oportunista que se encuentra comúnmente
...
estudios usando el modelo de \textit{C. albicans}. Existen
estudios proteómicos de la interacción con el hospedador, tanto desde el enfoque de
\textit{C. albicans} \citep{Fernandez-Arenas2007}, como desde el enfoque de células
...
que utilizan {C. albicans} en diferentes condiciones.
