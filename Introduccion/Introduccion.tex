...
\ac{FTICR} se basan en confinar los iones
...
que el la proporción de la variación entre clases (asignaciones correctas
...
una distribución \textit{Gamma}($\alpha$, $\beta$, $\delta$). 
...
influyen en las distribuciones mencionadas de PSM incorrectos y PSM correctos.
Concretamente se ha comprobado 
que el número de extremos trípticos, \ac{NTT}, el número de puntos de 
corte no efectuados, \ac{NMC} y el error en la masa del precursor, $\Delta$M,
tienen individualemente distribuciones diferentes
...
A continuación, PeptideProphet usa un algoritmo de Expectación-Maximización,
...
que definen la \textit{Normal}; y $\alpha$, $\beta$, $\delta$, que definen la \textit{Gamma}.
