...
fragmentos de iones precursores diferentes con similares \mz.
{}
...
Por otra parte, para organismos cuyos genomas estén secuenciados, existen 
bases de datos de las secuencias de sus proteínas.
La elección de la mejor proteína candidata, o péptido candidato, que ha 
generado ese espectro, consiste, en esencia, en 
estimar el grado de similitud entre los valores \mz empíricos obtenidos
en el espectro y los valores \mz calculados que teóricamente se producen a
partir de una digestión predicha computacionalmente de las secuencias
en la base de datos.
...
ionizados y dentro del espectrómetro, vuelven a ser sometidos a una 
...
MS\textsuperscript{1}, se seleccionan algunos de estos iones, llamados 
iones o péptidos \emph{precursores}, para ser rotos en péptidos más 
...
\textit{Por último, algunos espectrómetros tienen la capacidad de producir 
...
que indica el numero de residuos en el fragmento. (Figura~\ref{fig:peptide_fragmentation})
...
se les suministra una lista de espectros empíricos MS/MS y una serie de
...
teóricos obtenidos mediante una predicción de las masas de los
...
Buscar apuntes del curso de Bioestadística de Diciembre de 2010 de
Jesus Vazquez y Cía, en la UAM, un día llevaba la guitarra de Guitar Hero
