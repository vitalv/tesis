...
La estrategia básica en Proteómica consiste en la elección del mejor
...
por un proceso denominado \emph{Disociación Inducida por Colisión} (CID), aunque
existen también otros tipos de fragmentación como la \emph{Disociación por 
Transferencia Electrónica} (ETD) o \emph{Disociación por Alta Energía de Colisión} (HCD).
...
%-------------------------------------------------------------------
\phantomsection
\section*{Proteómica de alto rendimiento. Proteómica \textit{Shotgun}}
\addcontentsline{toc}{section}{Proteómica de alto rendimiento. Proteómica \textit{Shotgun}}
...
Al igual en el caso de los motores de búsqueda basados en secuencia, 
existe un tipo de específico de \textit{software} que permite crear 
...
En un experimento de proteómica shotgun, desde el momento de la digestión
