...
m es la masa molecular del analito y z un múltiplo entero del número de 
...
En la \ac{MSMS} o MS\textsuperscript{2},
...
representa la hipótesis nula, una asignación \ac{PSM} por azar.
