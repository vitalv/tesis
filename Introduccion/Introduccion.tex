...
péptidos y por tanto aparece el problema de la trazabilidad en el 
...
lo que provoca una amplificación de las tasas de eror (\ref~\figura{fig:protein_inference_non_random_peptide_grouping}),
y también la pérdida de la trazabilidad, como consecuencia fundamentalmente
