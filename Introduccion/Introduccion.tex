...
péptidos. Esto, que permite que la estrategia de \textit{shotgun} pueda
...
y por tanto aparece el problema de la trazabilidad en el 
...
Los motivos que complican la inferencia de las proteínas son principalmente  
el agrupamiento dirigido de péptidos en sus correspondientes proteínas, 
lo que provoca una amplificación de las tasas de eror (\ref{fig:protein_inference_non_random_peptide_grouping}),
y también la pérdida de la correspondencia péptido-proteína, como consecuencia fundamentalmente
de péptidos compartidos o \textit{degenerados} cuyas secuencias están 
