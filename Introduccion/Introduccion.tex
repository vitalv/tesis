...
\textbf{Th}. Un thomsom equivale a 1 Da / e, donde e es la carga elemental.
...
o Cuadrupolo-Trampa Iónica, \ac{QTRAP} respectivamente.
...
La técnica de la Huella de Masas Peptídicas, \ac{PMF}, desarrollado a principios
de los años 90 por varios grupos independientemente \citep{Pappin1993,Henzel1993,Mann1993}
...
La Tecnología Multidimensional de Identificación de Proteínas \ac{MudPIT}
\citep{Wolters2001} integra una primera dimensión de separación usando 
una columna de intercambio catiónico \ac{SCX} y segunda dimensión consistente 
