...
como el procesamiento alternativo de intrones y las Modificaciones Post-Traduccionales o \ac{PTM}.
...
separación de proteínas y péptidos como la Electroforesis en Gel de Poliacrilamida,
\ac{PAGE} y la Cromatografía Líquida de Alto Rendimiento, \ac{HPLC}
...
El desarrollo de las técnicas de ionización suave de macromoléculas
...
Proteómica. Las técnicas de Ionización por ElectroSpray, \ac{ESI} \citep{Fenn1989a}
y Desorción Suave por Láser, \ac{SLD} 
\citep{Tanaka1988} permitieron que 
las grandes y frágiles moléculas biológicas como las proteínas pudieran 
ser ionizadas y volatilizadas relativamente intactas para ser posteriormente
 introducidas en los espectrómetros de masas.
...
en este caso, denominaron Ionización mediante Desorción por Láser Asistida por Matriz, \ac{MALDI} 
 \citep{Karas1988} Aunque \ac{MALDI} no fue aplicada a la ionización 
...
Otros tipos de ionización menos comunes son el Bombardeo Rápido Atómico,
\ac{FAB}, la Desorción por Campo Eléctrico, \ac {FD},  y la Desorción por
Plasma, \ac{PD}.
...
de \emph{tiempo de vuelo} o una \emph{trampa iónica} para formar un
Cuadrupolo-Tiempo de Vuelo, \ac{QTOF}
o Cuadrupolo-Trampa Iónica, \ac{QTRAP} \mbox{respectivamente}.
Algunos de los analizadores de masas más comunes son los siguientes:
...
\item \textbf{Analizadores de Tiempo de Vuelo}, \ac{TOF}
...
\subitem Las Trampas Iónicas Tridimensionales, \ac{QIT} 
...
\subitem Las Trampas Iónicas Lineales, \ac{LTQ} o \ac{LIT} consisten
...
\subitem Los analizadores de tipo  Resonancia Ionica Ciclotrónica - Transformada de Fourier,
...
para conseguir la amplificación de la señal. 
...
se usa un 50\% de altura del pico, el parámetro en ese caso es la Altura
de Pico a Media Altura, \ac{FWHM}.
...
como Huella Peptídica, descrita en la sección \ref{cap1:subsec:PMF}.
...
En la Espectrometría de Masas en Tándem, \ac{MSMS} o MS\textsuperscript{2},
...
pequeños -\emph{fragmentos}- en el interior del espectrómetro.
...
Adquisición Dependiente de Datos, \ac{DDA}
...
La Disociación Inducida por Colisión, \ac{CID} 
...
Otros tipos de fragmentación son la Disociación por Transferencia de
Electrones, \ac{ETD}, \citep{Syka2004}, en la que los iones de analito
...
la Disociación por Captura de Electrones, \ac{ECD} \citep{Zubarev1998},
consistente la interacción del analito con electrones suministrados 
directamente; y, por último, la Disociación por Colisión de Alta Energía, \ac{HCD}
usado en analizadores tipo Orbitrap \citep{Olsen2007}, y que al igual que 
...
proporción a las proteínas \citep{Hatt1997}. Además la sensibilidad de los espectrómetros
...
La separación de proteínas por Electroforesis en Gel de Poliacrilamida, \ac{PAGE},
...
En la Electroforesis en Gel de PoliAcrilamida Monodimiensional, \ac{1DPAGE},
proteínas se separan en función de su peso molecular, las más pequeñas
se separan más en el gel. 
En la Electroforesis en Gel de PoliAcrilamida Bidimiensional, \ac{2DPAGE},
las proteínas se separan en una primera dimensión (sobre una tira con un
gradiente de pH inmobilizado) en función de su punto isoeléctrico para
...
empleada sea la Electroforesis en Gel de PoliAcrilamida con DodecilSulfato Sódico, \ac{SDSPAGE}.
...
Generalmente la técnica de la Huella Peptídica, conocida también por 
el acrónimo PMF, \ac{PMF}, se lleva a cabo por 
...
Proteómica a gran escala o \textit{shotgun}. Como se describe en las
...
%\phantomsection
\section{Proteómica a gran escala}
%\addcontentsline{toc}{section}{Proteómica de alto rendimiento \textit{Shotgun}}
\label{cap1:sec:Proteómica shotgun}

La Proteómica a gran escala, conocida generalmente por el término inglés
\textit{shotgun}, es la técnica de elección para la mayoría
...
Pero el fraccionamiento más importante se hace a nivel de péptido, trás 
...
es la que se conoce como Cromatografía Líquida de Alto Rendimiento en Fase Reversa, \ac{RPHPLC}
...
péptidos son ionizados e introducidos en el espectrometro de masas.
...
se les denomina generalmente Asignación Péptido-Espectro, \ac{PSM}.
...
para el mismo set de espectros con una ventana más restrictiva \citep{Ding2008, Nesvizhskii2010}.
...
es calculado como una función de correlación \emph{Corr(t)} (el producto 
...
%\phantomsection
\section{Evaluación estadística de las asignaciones PSM}
...
\begin{itemize}
 \item\textit{sensibilidad} o Tasa de Verdaderos Positivos, \ac{TPR}. Es la proporción
...
\item Tasa de Falsos Negativos, \ac{FNR}. Es la proporción
...
\item Tasa de Falsos Positivos, \ac{FPR}. Es la proporción
...
\item Tasa de Falsos Descubrimientos, \ac{FDR}. Es la proporción
...
\end{itemize}
\figura{Vectorial/tabla_contingencia_estadistica_basica}{width=.99\textwidth}{fig:tabla_contingencia_estadistica_basica}%
...
ocurrir \ac{PSM} con \mbox{\emph{p-valores}} igualmente bajos solo por azar. Por este
...
Aunque en su versión original, el software requería una población de asignaciones
...
\figura{Vectorial/PeptideProphet_fit_2_a_dataset_of_D_scores}{width=1\textwidth}{fig:PeptideProphet_fit_2_a_dataset_of_D_scores}%
{Estimación de PeptideProphet de las distribuciones de PSM incorrectos y correctos}
...
Concretamente  
el número de extremos trípticos, \ac{NTT}, el número de puntos de 
corte no efectuados, \ac{NMC} y el error en la masa del precursor, $\Delta$M,
...
A continuación, PeptideProphet usa un algoritmo de Esperanza-Maximización,
...
O dicho con otras palabras, la probabilidad de que, teniendo una puntuación 
\textit{S}, una asignación sea incorrecta con respecto a la probabilidad
de tener esa puntuación. Este valor es la Probabilidad de Error Posterior, \textit{PEP}
...
la estrategia \textit{target-señuelo} pues no se había generalizado aún.
...
en el sentido de que la clase (PSM correctos e incorrectos) pasa a ser
conocida para algunas pero no todas las asignaciones.
...
como \textit{el problema de la inferencia de proteínas} en \citep{Nesvizhskii2005},
...
puede indicar la presencia de ninguna de las proteínas de la familia en particular.
...
de análisis. ProteinProphet refina las probabilidades de cada PSM previamente
...
en cuenta el número de péptidos hermanos, \ac{NSP} de forma que se
...
El reajuste teniendo en cuenta el parámetro \ac{NSP} se realiza con una
...
y tasas de error de forma muy precisa. Sin embargo, la modelización que
emplean a veces resulta demasiado excesiva, especialmente en casos de 
...
desarrollada para resolver este tipo de necesidades, implementando una
modelización más completa de todas las fuentes de información en un 
...
El número de búsquedas, \ac{NSS}, que aumenta las probabilidades de una
secuencia peptídica si es identificada por múltiples motores de búsqueda;
el número de espectros repetidos, \ac{NRS}, que tiene en cuenta si hay 
muchos espectros que son asignados a la misma secuencia con alta probabilidad;
el número de réplicas, \ac{NSE}, que aumenta las probabilidades de péptidos
...
el número de iones de un péptido, \ac{NSI}, que aumenta la probabilidad
de un péptido si es encontrado en distintos estados de carga; y por último
el número de instancias modificadas, \ac{NSM}, que actúa de forma similar
...
%\phantomsection
\section{Repositorios públicos de Proteómica a gran escala y dirigida}
...
Depende básicamente, de la forma %a lo mejor puedo recortar esto 
...
Así, para los instrumentos Thermo Scientific el formato es del primer tipo, 
...
toda la información de salida de MS, mzXML \citep{Pedrioli2006} y mzData \citep{}
...
\textit{Candida albicans} es un hongo patógeno oportunista que se encuentra comúnmente
como residente comensal, inocuo, en las mucosas gastrointestinal y urogenital en
un alto porcentaje de la población. Sin embargo, su cualidad de patógeno
...
mucocutáneas leves hasta infecciones sitémicas severas que pueden incluso llegar a ser letales.


\figura{Vectorial/candida_vs_macrophage}{width=.99\textwidth}{fig:candida_vs_macrophage}%
{Status de equilibrio entre las células de \textit{Candida albicans}
 y células del sistema inmune en las mucosas}

Los principales factores de virulencia con los que cuenta \textit{Candida albicans}
para proliferar y diseminarse causando infecciones son su capacidad
de cambiar su morfología de una forma levaduriforme a una forma hifal,
siendo la primera más adecuada para la diseminación y la segunda para
penetrar e invadir tejidos; y su capacidad de adhesión gracias a la acción
de proteínas adhesinas \citep{Calderone2001}



Desde el punto de vista de la Proteómica, se han realizado muy diversos
estudios usando Candida 
Estudios basados en 2D-PAGE para investigar las diferencias en el proteoma
de la forma de levadura y la forma de hifa
