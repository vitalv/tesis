...
de diagnóstico y pronóstico de candidiasis \citep{Pitarch2006b, Pitarch2011}.

Sin embargo, a pesar de la extensa variedad de estudios proteómicos abordados, la presencia
...
\subsection{Candida Genome Database, CGD. Base de datos del genoma de Candida}
\label{CGD}
