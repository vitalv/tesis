...
fuera de dicho rango. Solo aquellos péptidos que cumplen este requisito
son comparados con el espectro obtenido y puntuados en base a su similitud.
...
o bien, puede considera que existe una proporción variable de isótopos 
...
Es importante que, en función del tipo de instrumento y de fragmentación,
...
péptidos candidatos presentes en la base de datos de referencia, la
salida del \textit{software} es una lista de péptidos ordenados en función 
...
de un experimento.
Al igual que los estadísticos p-valor y e-valor evalúan la calidad en las
...
La proteómica dirigida se distingue de las técnicas de \textit{shotgun},
esencialmente, en el objetivo. Esta metodología no pretende identificar
...
La tecnología que se utiliza para llevar a cabo experimentos de proteómica
...
Las técnicas de proteómica dirigida basadas en SRM están actualmente 
