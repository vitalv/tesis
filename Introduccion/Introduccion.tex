...
fragmentación adicional. (Figura~\ref{fig:Espectrometría de masas en Tandem. MS/MS})
%\begin{itemize}
...
%  \item Cromatografía líquida en fase reversa (RP-LC)
  ...
  hidrofóbico. 
  La fase sólida, apolar, está compuesta por unas micro-esferas de sílice cubiertas
  de cadenas con 18 átomos de C (C18)
  Un gradiente en que el solvente orgánico aumente gradualmente
  hace que los 
