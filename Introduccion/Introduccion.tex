...
espectrometría de masas es la \emph{Disociación Inducida por Colisión} (CID),
que consiste en hacer chocar a las moléculas de analito con átomos o moléculas
de gases nobles, Argón o Xenón en triples cuadrupolos o Helio, en las trampas iónicas.
La fragmentación tipo CID genera una elevada proporción de iones de las 
series \emph{-b} e \emph{-y}

Sin embargo, existen también otros tipos de fragmentación como la \emph{Disociación por 
Transferencia Electrónica} (ETD), en  el  que se  utilizan  radicales  
aniónicos  capaces  de  interaccionar con los iones con carga positiva 
del péptido y  transferirles  un  electrón  produciendo  un  tipo  de 
fragmentación parecido al de ECD, rico en iones c y z (Syka et al., 2004; Chi et al., 2007).

 o \emph{Disociación por Alta Energía de Colisión} (HCD).
...
Básicamente, \emph{Xcorr} contabiliza el numero de fragmentos coincidentes
...
en contar el numero de picos compartidos entre los espectros teórico y empírico,
