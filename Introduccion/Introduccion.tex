...
A partir de un espectro MS se obtiene el valor \mz del péptido y
...
oxidaciones que se pueden producir en las metioninas (M).
Otro tipo de modificaciones son las llamadas fijas, como la carbamidometilación
en las cisteínas (C), un artefacto que se produce siempre 
...
por ejemplo, a un átomo de oxígeno o un grupo carbamido-metil.
