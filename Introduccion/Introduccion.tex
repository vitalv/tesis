...
En algunos análisis pueden ser necesario realizar fragmentaciones adicionales
...
de Roepstorff \citep{Roepstorff1984}, se clasifican, según el punto en
...
\subsubsection*{Tipos de fragmentación}

Uno de los métodos de fragmentación más frecuentemente utilizados en
espectrometría de masas para Proteómica es la \emph{Disociación Inducida por Colisión} (CID),
que consiste en hacer colisionar a las moléculas de analito con átomos o moléculas
de gases nobles, químicamente inertes. Argón o Xenón 
son generealmente usados en triples cuadrupolos y Helio en las trampas iónicas.
...
como en ETD, los electrones son suministrados por aniones y transferidos 
hacia los cationes de analito. ECD se usa generalmente en espectrómetros
tipo FTICR y en trampas iónicas y genera abundantes fragmentos de series
\emph{c-}, \emph{z-} y, aunque en menor medida, también de la serie \emph{a-}
...
se generan más fragmentos de un tipo o de otro. (Ref)
...
en alineamiento de espectros o usando reglas derivadas más complejas.


%SEQUEST%%%
SEQUEST \citep{Eng1994} fue la primera herramienta descrita que correlacionaba
...
Pero además, SEQUEST proporciona un valor de puntuación adicional, 
...
mejor cuanto mas altas sean estas puntuaciones.

%X!TANDEM%%%
Otro motor de búsqueda frecuentemente utilizado es X!Tandem \citep{Craig2004},
...
%MASCOT%%%
Mascot es quizá el más popular de los motores de búsqueda, calcula una 
...
asignado a un espectro, es decir aquel con la mejor puntuación,
...
\subsubsection*{Tasa de Falsos Positivos, FDR y Probabilidad de Error Posterior, PEP}

En el caso de experimentos de alto rendimiento en los que se producen
miles de espectros, la evaluación estadística mas ampliamente utilizada
es la \emph{Tasa de Falsos Descubrimientos (FDR, False Discovery Rate)} \citep{Benjamini1995}.
Básicamente, el concepto FDR, se refiere a la proporción de falsos positivos
que se aceptan en todo el conjunto de PSMs de un experimento para un umbral
de puntuación (o de \emph{p-valor}) fijado.
