...
Por eso el término \emph{proteoma} es más flexible y puede ajustarse a definiciones mas específicas.
...
\figuraEx{Vectorial/tandem_ms}{width=.95\textwidth}{fig:tandem_ms}%
...
\figura{Vectorial/roepstorff_nomenclature}{width=.65\textwidth}{fig:peptide_fragmentation}%
