...
{Algunos de los analizadores de masas más comunes son los de tipo
 Cuadrupolo (a), Orbitrap (b) y Trampa Iónica Tridimensional (c)}{Analizadores de masas}
...
{En la espectrometría de masas en Tándem se seleccionan péptidos%
precursores, generalmente los de mayor intensidad en el espectro MS\textsuperscript{1}, para%
...
son separados mediante cromatografía. A medida que eluyen, los péptidos
...
\figuraEx{Vectorial/spectrum_interpret_from_man_to_auto_2}{width=.75\textwidth}{fig:spectrum_interpretation_2}%
...
\figuraEx{Vectorial/evalue_estimation}{width=.95\textwidth}{fig:evalue_estimation}%
...
%\phantomsection
\section{Repositorios públicos de Proteómica online}
...
estudios usando el modelo de \textit{Candida albicans}. En este sentido
los experimentos proteómicos se han enfocado principalmente en el esudio
de los rasgos patógenos. Existen estudios enfocados al estudio del proteoma 
