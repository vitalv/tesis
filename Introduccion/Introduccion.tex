...
1994 en analogía al concepto de Genoma \citep{Wasinger1995} 
...
\mbox{\ac{PAGE}} y la Cromatografía Líquida de Alto Rendimiento, \ac{HPLC}
...
se usa acoplada a analizadores de tipo Tiempo de Vuelo, \ac{TOF} que miden
el tiempo que tardan los analitos ionizados en llegar al detector a través
del vacío.

\item En \textbf{\ac{ESI}} (Figura~\ref{fig:maldi_y_esi} b) el analito se encuentra en fase líquida en un solvente
...
%\phantomsection
\subsection{Separación de péptidos y proteínas}
...
{Interpretación de espectros MS/MS. Identificación \textit{de novo}}
