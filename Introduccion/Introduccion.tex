...
las grandes y lábiles moléculas biológicas como las proteínas pudieran 
...
de análisis. 
De forma general se puede calcular la probabilidad de una proteína P
...
de datos (DDA), en la Proteómica dirigida la adquisición es independiente de los datos
\ac{DIA}
...
de \textit{shotgun}. Las técnicas SRM proporcionas unas propiedades muy interesantes en
