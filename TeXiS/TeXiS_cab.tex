...
%nota Vital: (comento el headheight anterior y fijo el siguiente:
\setlength{\headheight}{26pt}
%para evitar los warning en la compilacion
% Package Fancyhdr Warning: \headheight is too small (14.0pt): 
% Make it at least 25.22652pt.
...
%\markboth{\textsc{\chaptertitlename\ \thechapter.}\ #1}{}% Vital. No quiero que ponga Capitulo 1. Introduccion
}
