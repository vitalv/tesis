...
\def\@spart#1{%
    ...
    %VITAL: esta parte me permite añadir al toc el título de la parte, sin número romano ni nada
    %para evitar que la parte el capitulo 2 esté bajo la parte III (parte II es objetivos y no lleva ningun capitulo) 
    \renewcommand\thepart{}
    \ifnum \c@secnumdepth >-2\relax      
      \refstepcounter{part}%
      \addcontentsline{toc}{part}{\thepart\hspace{1em}#1}%
