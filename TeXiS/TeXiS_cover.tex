...
\textit{Memoria que presenta para optar al título de Doctor}  \\ [0.3em]%
...
\textit{Dirigido por la Doctora}  \\ [0.3em]
...
\textbf{Desarrollo de herramientas bioinformáticas}
}
\begin{center}
\rule{\longTitulo}{.5mm}\\
\vskip 1cm
