...
\ifpdf
   \RequirePackage[pdfborder=0,colorlinks=true,hyperindex,pdfpagelabels]{hyperref}
...
%titlesec customizes chapters, sections and subsections styles
%\usepackage{titlesec}
\titleformat{\chapter}[display]
{\bfseries\Large\slshape}
{\filleft}
%{\filleft \Huge\textcolor{gray}\thechapter}
%{-2ex}
{-2ex}
{%\titlerule
\vspace{2ex}%
...
% Paquete que incluyo para poder insertar pdfs (de los papers) dentro de los capitulos
\usepackage{pdfpages}



% Paquete de matematicas, para ecuaciones y tal
...
%\usepackage{relsize}%para poder reducir un poco 9pt. 8pt es demasiado pequeño

\usepackage{extsizes} %para poder poner 9pt en book

%\usepackage[document]{ragged2e} %para right align \begin{flushright} (titulos partes)

\usepackage{setspace} %para poder ajustar \baselinestretch en algunas partes. como en la discusion para que ocupe más
...
%me permite quitar el espacio a la izq de cada item en la bibliografia de los capitulos poniendo \setitemize[0]{leftmargin**}
\usepackage{enumitem}



%para cambiar el margen externo, que en a4 es too large
\usepackage{geometry}
\geometry{
 %b5paper, %comentar para imprimir B5 en A4
 a4paper, %comentar para volver a B5
 layout=b5paper, %comentar para volver a B5
 layoutvoffset=23mm, %comentar para volver a B5
 layouthoffset=10mm, %comentar para volver a B5
 twoside,
 showcrop, %comentar para volver a B5
% outer=40mm,
 %total={170mm,257mm},
 %left=20mm,
 top=35mm
...
%EN A4 me queda un margen exterior muy ancho. Pongo esto para desplazar todo el textblock hacia afuera:
...
%EN B5 también pero menos
\newlength{\textblockoffset}
\setlength{\textblockoffset}{6mm}
\addtolength{\hoffset}{\textblockoffset}
\addtolength{\evensidemargin}{-2.0\textblockoffset}


%Incluir marcas de corte, imprimir en A4
%\usepackage[a4,cam,center,pdftex]{crop}