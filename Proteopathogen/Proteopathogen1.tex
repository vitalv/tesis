...
\chapter*{Proteopathogen, a protein database for studying \mbox{\textit{Candida albicans}} - host interaction}
...
case of \textit{C. albicans} proteins, identifiers, synonyms, aminoacid
...
are found for \textit{C. albicans} proteins, \textit{S. cerevisiae} orthologs
...
reductase QCR2 of \textit{C. albicans} which has been reported to
...
Candida albicans gene and protein information., Nucleic acids research, 33(Database issue), D358-63.
}
...
\item[]{
Cabezón, V., Llama-Palacios, A., Nombela, C., Monteoliva, L., and Gil, C. (2009), Analysis of
...
\item[]{
Csank, C., Costanzo, M. C., Hirschman, J., Hodges, P., Kranz, J. E., Mangan, M., OÑeill,
...
\item[]{
Fernández-Arenas, E., Cabezón, V., Bermejo, C., Arroyo, J., Nombela, C., Diez-Orejas, R.,
and Gil, C. (2007), Integrated proteomics and genomics strategies bring new insight into
Candida albicans response upon macrophage interaction, Molecular \& cellular proteomics
: MCP, 6(3), 460-478.
}
...
\item[]{
Martínez-Solano, L., Nombela, C., Molero, G., and Gil, C. (2006), Differential 
protein expression of murine macrophages upon interaction with Candida albicans, Proteomics, 6 Suppl
1, S133-S144.
}
...
\item[]{
Pitarch, A., Abian, J., Carrascal, M., Sánchez, M., Nombela, C., and Gil, C. (2004),
Proteomics-based identification of novel Candida albicans antigens for diagnosis 
...
\item[]{
Rossignol, T., Lechat, P., Cuomo, C., Zeng, Q., Moszer, I., and DÉnfert, C. (2008), 
