...
\partTitle{
 %\begin{flushright}
  \sc{Desarrollo de una aplicación web para recoger, visualizar y analizar resultados de estudios de proteómica de \textit{Candida albicans}}
 %\end{flushright}
}
...
\part%
[\sc{Desarrollo de una aplicación web para recoger, visualizar \\%
y analizar resultados de estudios de proteómica \\%
