...
\partTitle{
 %\begin{flushright}
  \sc{Desarrollo de una aplicaci\'on web para recoger, visualizar y analizar resultados de estudios de prote\'omica de \textit{Candida albicans}}
 %\end{flushright}
}
...
\part%
[\sc{Desarrollo de una aplicaci\'on web para recoger, visualizar \\%
y analizar resultados de estudios de prote\'omica \\%
